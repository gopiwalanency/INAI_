      ...
      <div className="service-detail-page model-training-page">
        ...
        <div className="sticky-scroll-section">
          ...
          <p style={{ textAlign: 'center', color: '#e2e8f0', marginTop: '2rem', fontSize: '1.05rem' }}>
            All training begins with Reliable <Link to="/data-collection" style={{ color: 'skyblue', textDecoration: 'none' }}><strong>Data Collection for AI & ML</strong></Link>, where diverse and accurate raw datasets are gathered before <Link to="/data-structuring" style={{ color: 'skyblue', textDecoration: 'none' }}><strong>structuring Data</strong></Link> and model training.
          </p>
        </div>
